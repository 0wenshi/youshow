 ...
 <div className="bg-transparent p-7 font-sans flex flex-col lg:flex-row items-center">
      <div className="lg:w-1/2 space-y-4 flex flex-col items-center my-5">
        ...
        <div className="w-[300px] text-left">
          ...
          <ul className="list-disc ml-6 mt-2 space-y-2">
            ...
            <li>保留观众反应良好的部分，删减或修改不够精彩的内容，再次在开放麦中测试。</li>
            <li>经过多次测试和调整，最终打磨出一个成熟的段子，可以用于商业演出。</li>
          </ul>
          <p className="mt-4 leading-relaxed">
      ...
      <div className='lg:w-1/2 space-y-4 flex flex-col items-center my-5'>
        ...
        <div className='w-[300px]'>
          ...
          <p className='leading-relaxed'>根据表演规模和性质的不同，脱口秀通常分为以下三种演出形式：</p>
          <ul className='list-none ml-0 mt-4 space-y-4'>
            <li> 
                <p className='font-semibold'>1. 开放麦(Open Mic)</p>
                <p className='leading-relaxed'>开放麦是脱口秀演员练习和试验新段子的地方。老演员会在开放麦试验和打磨新段子，同时也会有新演员的登台。可以说，开放麦是某种意义上的“盲盒”演出。</p>
            </li>
            <li>
                <p className='font-semibold'>2. 商演拼盘(Commercial Shows)</p>
                <p className='leading-relaxed'>商演拼盘是由多位脱口秀演员联合演出的形式,每位演员表演10～15分钟左右。拼盘演出风格多样,可以让观众一次性体验不同演员的喜剧风格。</p>
            </li>
            <li>
               <p className='font-semibold'>3. 专场/主打秀</p>
               <p className='leading-relaxed'>专场是一位演员独立完成的个人演出,通常时长为60分钟左右,内容围绕一个核心主题展开。主打秀则是更短时长的表演,约45分钟左右,但同样需要经过充分的创作与打磨。这种形式要求演员具备深厚的创作能力和舞台表现力。</p>
            </li>
          </ul>
        </div>
      </div>
