...
var pn = Math.random().toString(36).slice(2),
  ...
  Tl = '__reactMarker$' + pn;
function lo(e) {
  delete e[we], delete e[Me], delete e[Pr], delete e[Zp], delete e[Jp];
}
function Rn(e) {
  var t = e[we];
  if (t) return t;
...
function xh(e) {
  ...
  function c(p, g, v, S, w) {
    return g === null || g.tag !== 7
      ? ((g = Ln(v, p.mode, S, w)), (g.return = p), g)
      : ((g = l(g, v)), (g.return = p), g);
  }
  function h(p, g, v) {
    if (
    ...
    if (typeof g == 'object' && g !== null) {
      ...
      if (sl(g) || Xa(g))
        return (g = Ln(g, p.mode, v, null)), (g.return = p), g;
      ...
      switch (v.$$typeof) {
        case fi:
          e: {
            ...
            v.type === ia
              ? ((S = Ln(v.props.children, p.mode, S, v.key)),
                (S.return = p),
                (p = S))
...
function Ui(e, t) {
  t === null ? ee(Mn, Mn.current) : ee(Mn, t.pool);
}
function wh() {
  var e = vo();
...
function ko() {
  if (q !== null) {
    ...
    else (e = q), (Lt = Fn = null), wo(e), (xa = null), (zl = 0), (e = q);
...
var Vt = W.d;
W.d = { f: My, r: Ly, D: _y, C: Hy, L: By, m: ky, X: Yy, S: qy, M: Vy };
function My() {
  var e = Vt.f(),
    t = Ys();
  return e || t;
    ...
    for (a = 0; a < n.length; a += 3) {
      ...
      if (typeof i == 'function') s || Tf(n);
        ...
        if (i && i.hasAttribute('formAction')) {
          if (((l = i), (s = i[Me] || null))) r = s.formAction;
...
class js extends Ks {
  ...
  translate(t, n, a) {
    ...
    if (g && f && v && b.indexOf(x) < 0 && !(L(p) && Array.isArray(f))) {
      ...
      y = (b, p, g) => {
        ...
        return pa(p).reduce((w, O, T) => {
          ...
          if (O.type === 'tag') {
            ...
            M
              ? w.push(E.createElement(M, { key: `${O.name}-${T}` }, F))
              : w.push(F);
          }
          return w;
        }, []);
...
const G1 = '/images/actors/Annie.jpg',
  X1 = '/images/actors/Bazi.jpg',
  Q1 = '/images/actors/Charlotte.jpg',
  K1 = '/images/actors/Laohu.jpg',
  Z1 = '/images/actors/Qixue.jpg',
  J1 = '/images/actors/Summer.jpg',
  F1 = '/images/actors/Vincent.jpg',
  W1 = '/images/actors/Wanning.jpg',
  P1 = [
    { id: 'annie', image: G1 },
    { id: 'bazi', image: X1 },
...
function _S() {
  ...
  E.useEffect(() => {
    (async () => {
      try {
        const x = (
          await ie.get(`http://localhost:3000/events/${a}/${t + 1}`)
...
function HS() {
  ...
  E.useEffect(() => {
    (async () => {
      try {
        const y = await ie.get('http://localhost:3000/events');
        n(y.data);
      } catch (y) {
        console.error('Error fetching events:', y);
      }
...
function kS() {
  ...
  const o = async (c) => {
    ...
    c.preventDefault();
    try {
      const m = await ie.post('http://localhost:3000/auth/login', {
        identifier: e,
        password: n,
      });
      l
...
function qS() {
  const [e, t] = E.useState(''),
    ...
    h = async (f) => {
      ...
      try {
        await ie.post('http://localhost:3000/auth/register', {
          username: e,
          email: n,
          password: l,
        }),
